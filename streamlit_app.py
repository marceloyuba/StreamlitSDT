...
st.write('<div class="fixed-container"><img src="https://github.com/marceloyuba/StreamlitSDT/blob/main/scr/SDTLogoC.png?raw=true" /><br />"Pagina: [Acceder a la App](https://greyhound.streamlit.app/)"<br />con varias filas de contenido.</div>', unsafe_allow_html=True)
