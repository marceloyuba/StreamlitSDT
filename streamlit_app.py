...
st.write('<div class="fixed-container"><img src="https://github.com/marceloyuba/StreamlitSDT/blob/main/scr/SDTLogoC.png?raw=true" /><br />"[Ir a Sección 2](#Sobre nosotros)"<br />con varias filas de contenido.</div>', unsafe_allow_html=True)
